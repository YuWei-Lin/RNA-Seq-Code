...
for(j in 2:6){
  ...
  tiff(paste("C:/Users/tonyxp/Desktop/NMF_FILES/NMF_H/PV95_hhcoef_K", j,".tiff", sep=""), width=3000, height=3000, compression="lzw", res=300)
  heatmap.2(hh, labCol=colnames(hh), col=grcol, Rowv = FALSE, Colv = FALSE, dendrogram = "none", trace = "none", main = "hhcoef", cexRow = 1.2)
  dev.off()
