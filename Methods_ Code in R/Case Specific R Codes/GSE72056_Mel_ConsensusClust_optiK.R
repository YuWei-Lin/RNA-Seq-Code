...
meldat <- read.csv("D:/ALL_FINAL_RESULTS/GSE72056_Melanoma_DATA/K.Means Clustering/Inputs/GSE72056_MelanomaCan_RAW_CDF.csv", header = TRUE)
...
tumors_colors=rep(colors[1], 1179)
...
main_title="GSE72056_Melanoma_tumors_optimalK"
title=paste("D:/ALL_FINAL_RESULTS/GSE72056_Melanoma_DATA/K.Means Clustering/ClusterGeneLists", sep = "")
...
for(k in 2:12){
  ...
  Cluster_Colors=rep(CCP_colors[1], 8119)
  for(j in 2:k){
  ...
  tiff(paste("D:/ALL_FINAL_RESULTS/GSE72056_Melanoma_DATA/K.Means Clustering/ClusterGeneLists/", main_title, ".tiff", sep=""), width=2200, height=1600, compression="lzw", res=300)
  ...
  legend("topright",legend=c(names(table(as.character(meldat[1,])))), fill=colors[1:15], border=FALSE, bty="n", y.intersp = 1, cex=0.7)
  dev.off()
  for(y in 1:as.numeric(k)){
    ...
    write.table(CGset, file = paste("D:/ALL_FINAL_RESULTS/GSE72056_Melanoma_DATA/K.Means Clustering/ClusterGeneLists/GSE72056_Mel_ClusGenes_K", k, "C", y, ".csv", sep = ""), quote = F, row.names = F, sep = ",") 
  }
}
t_time <- proc.time()-p_time
print(t_time)
...
for(i in 2:12){
  ...
  file1 <- paste("D:/ALL_FINAL_RESULTS/GSE72056_Melanoma_DATA/K.Means Clustering/GeneColorsLists/GSE72056_Melanoma_CPP_K=", i, ".csv",sep = "")
