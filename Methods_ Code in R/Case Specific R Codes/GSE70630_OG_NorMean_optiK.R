...
title=paste("D:/SC Cases Completed/GSE70630_OG_DATA/Normal/K.Means/Filled with Mean/ConsensusClusterPlus.Figures", sep = "")
...
for(k in 2:12){
  ...
  tiff(paste("D:/SC Cases Completed/GSE70630_OG_DATA/Normal/K.Means/Filled with Mean/K_Heatmaps/", main_title, ".tiff", sep=""), width=2200, height=1600, compression="lzw", res=300)
  ...
  for(y in 1:as.numeric(k)){
    ...
    write.table(CGset, file = paste("D:/SC Cases Completed/GSE70630_OG_DATA/Normal/K.Means/Filled with Mean/ClusterGeneLists/GSE70630_OG_ClusGenes_K", k, "C", y, ".csv", sep = ""), quote = F, row.names = F, sep = ",") 
  }
}
t_time <- proc.time()-p_time
print(t_time)
...
for(i in 2:12){
  ...
  file1 <- paste("D:/SC Cases Completed/GSE70630_OG_DATA/Normal/K.Means/Filled with Mean/GeneColorsLists/GSE81383_Melanoma_CPP_K=", i, ".csv",sep = "")
