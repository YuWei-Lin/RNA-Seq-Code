...
op <- list.files(paste("D:/ALL_FINAL_RESULTS/", CaseN, "_DATA/K.Means Clustering/GeneColorsLists", sep = ""), pattern = "CPP_K")
Clust.Col <- NULL
for (i in 1:12) {
  dt <- read.csv(paste("D:/ALL_FINAL_RESULTS/", CaseN, "_DATA/K.Means Clustering/GeneColorsLists/", op[i], sep = ""), header = T, stringsAsFactors = F)
  for (p in 1:(i+1)) {
...
hist(Global.ratio)
tiff(paste("D:/ALL_FINAL_RESULTS/", CaseN, "_DATA/K.Means Clustering/K_Maps/", CaseN,"_Whole_Overlapping_ParentRatio.tiff", sep = ""), width=1600, height=1600, compression="lzw", res=300)
hist(Global.ratio)
...
tiff(paste("D:/ALL_FINAL_RESULTS/", CaseN, "_DATA/K.Means Clustering/K_Maps/", CaseN,"_General_Tree_ParentView.tiff", sep = ""), width=2400, height=3200, compression="lzw", res=300)
...
hist(Global.ratio)
tiff(paste("D:/ALL_FINAL_RESULTS/", CaseN, "_DATA/K.Means Clustering/K_Maps/", CaseN,"_Whole_Overlapping_ChildRatio.tiff", sep = ""), width=1600, height=1600, compression="lzw", res=300)
hist(Global.ratio)
arrows(0.2, 250, 0.4, 350, lwd = 0.5)
arrows(0.4, 250, 0.6, 350, lwd = 2.5)
arrows(0.6, 250, 0.8, 350, lwd = 5.0)
...
tiff(paste("D:/ALL_FINAL_RESULTS/", CaseN, "_DATA/K.Means Clustering/K_Maps/", CaseN,"_General_Tree_ChildView.tiff", sep = ""), width=2400, height=3200, compression="lzw", res=300)
plot(NULL, type="n", xlab="", ylab="", xlim=c(0, 40), ylim=c(-80, 400), main = CaseN, axes = F)
#1 For generating cumulative numbers of knots and arrows ammount within certain K
CX <- NULL
MP <- NULL
