...
title=paste("D:/SC Cases Completed/GSE75688_Breast_DATA/Normal/K.Means/Filled with Zero/ConsensusClusterPlus.Figures", sep = "")
...
for(k in 2:12){
  ...
  tiff(paste("D:/SC Cases Completed/GSE75688_Breast_DATA/Normal/K.Means/Filled with Zero/K_Heatmaps/", main_title, ".tiff", sep=""), width=2200, height=1600, compression="lzw", res=300)
  ...
  for(y in 1:as.numeric(k)){
    ...
    write.table(CGset, file = paste("D:/SC Cases Completed/GSE75688_Breast_DATA/Normal/K.Means/Filled with Zero/ClusterGeneLists/GSE75688_Breast_ClusGenes_K", k, "C", y, ".csv", sep = ""), quote = F, row.names = F, sep = ",") 
  }
}
t_time <- proc.time()-p_time
print(t_time)
...
for(i in 2:12){
  ...
  file1 <- paste("D:/SC Cases Completed/GSE75688_Breast_DATA/Normal/K.Means/Filled with Zero/GeneColorsLists/GSE75688_Breast_CPP_K=", i, ".csv",sep = "")
